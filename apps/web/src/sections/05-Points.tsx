...
export function Points() {
  return (
    <section id="points" className="relative h-auto overflow-hidden bg-canvas px-[10px] pb-[242px] pt-24 md:h-[643px] md:px-5 md:pb-0">
      ...
      <div className="absolute bottom-0 left-0 h-[242px] w-full overflow-hidden">
        <div className="flex h-full -translate-x-[180px]">
